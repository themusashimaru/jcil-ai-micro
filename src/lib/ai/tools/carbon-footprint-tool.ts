...
const EMISSION_FACTORS: Record<string, EmissionFactor> = {
  ...
  natural_gas_stationary: {
    ...
    scope: 1,
    source: 'EPA GHG Emission Factors',
    uncertainty: 0.05,
  },
  gasoline: {
    factor: 2.31,
...
const REDUCTION_STRATEGIES: ReductionStrategy[] = [
  // Energy
  {
    ...
    cobenefits: ['Energy security', 'Cost stability'],
  },
  {
    sector: 'energy',
    ...
    timeframe: 'immediate',
    cobenefits: ['Lower energy bills', 'Less maintenance'],
  },
  {
    sector: 'energy',
    action: 'Improve building insulation',
    potentialReduction: '10-20%',
    implementationCost: 'medium',
    timeframe: 'medium_term',
    cobenefits: ['Comfort', 'Lower bills'],
  },
  {
    sector: 'energy',
    action: 'Install heat pumps',
    potentialReduction: '15-25%',
    implementationCost: 'high',
    timeframe: 'medium_term',
    cobenefits: ['Efficiency', 'Cooling capability'],
  },
  {
    sector: 'energy',
    action: 'On-site solar PV',
    potentialReduction: '10-30%',
    implementationCost: 'high',
    timeframe: 'medium_term',
    cobenefits: ['Energy independence', 'Revenue'],
  },
  ...
  // Transportation
  {
    ...
    implementationCost: 'high',
    timeframe: 'medium_term',
    cobenefits: ['Lower fuel costs', 'Air quality'],
  },
  {
    sector: 'transport',
    action: 'Remote work policy',
    potentialReduction: '5-15%',
    implementationCost: 'low',
    timeframe: 'immediate',
    cobenefits: ['Employee satisfaction', 'Office cost reduction'],
  },
  {
    sector: 'transport',
    action: 'Optimize logistics routes',
    potentialReduction: '3-8%',
    implementationCost: 'low',
    timeframe: 'short_term',
    cobenefits: ['Cost savings', 'Time efficiency'],
  },
  {
    sector: 'transport',
    action: 'Shift to rail freight',
    potentialReduction: '5-15%',
    implementationCost: 'medium',
    timeframe: 'medium_term',
    cobenefits: ['Reliability', 'Scalability'],
  },
  {
    sector: 'transport',
    action: 'Video conferencing vs travel',
    potentialReduction: '2-10%',
    implementationCost: 'low',
    timeframe: 'immediate',
    cobenefits: ['Time savings', 'Cost savings'],
  },
  ...
  // Supply chain
  {
    ...
    implementationCost: 'medium',
    timeframe: 'medium_term',
    cobenefits: ['Risk reduction', 'Innovation'],
  },
  {
    sector: 'supply_chain',
    action: 'Local sourcing',
    potentialReduction: '3-10%',
    implementationCost: 'medium',
    timeframe: 'short_term',
    cobenefits: ['Resilience', 'Community support'],
  },
  {
    sector: 'supply_chain',
    action: 'Circular economy practices',
    potentialReduction: '5-20%',
    implementationCost: 'medium',
    timeframe: 'medium_term',
    cobenefits: ['Resource efficiency', 'Waste reduction'],
  },
  {
    sector: 'supply_chain',
    action: 'Sustainable packaging',
    potentialReduction: '1-5%',
    implementationCost: 'low',
    timeframe: 'short_term',
    cobenefits: ['Brand image', 'Waste reduction'],
  },

  // Operations
  {
    sector: 'operations',
    action: 'Energy management system',
    potentialReduction: '5-15%',
    implementationCost: 'medium',
    timeframe: 'short_term',
    cobenefits: ['Visibility', 'Cost control'],
  },
  {
    sector: 'operations',
    ...
    implementationCost: 'medium',
    timeframe: 'medium_term',
    cobenefits: ['Efficiency', 'Quality'],
  },
  {
    sector: 'operations',
    action: 'Waste reduction program',
    potentialReduction: '1-5%',
    implementationCost: 'low',
    timeframe: 'short_term',
    cobenefits: ['Cost savings', 'Compliance'],
  },
  {
    sector: 'operations',
    action: 'Water efficiency',
    potentialReduction: '0.5-2%',
    implementationCost: 'low',
    timeframe: 'short_term',
    cobenefits: ['Cost savings', 'Water security'],
  },

  // Products
  {
    sector: 'products',
    action: 'Eco-design principles',
    potentialReduction: '10-30%',
    implementationCost: 'medium',
    timeframe: 'medium_term',
    cobenefits: ['Differentiation', 'Resource efficiency'],
  },
  {
    sector: 'products',
    action: 'Extended product lifetime',
    potentialReduction: '5-20%',
    implementationCost: 'low',
    timeframe: 'short_term',
    cobenefits: ['Customer loyalty', 'Less waste'],
  },
  {
    sector: 'products',
    action: 'Product-as-a-service model',
    potentialReduction: '10-40%',
    implementationCost: 'high',
    timeframe: 'long_term',
    cobenefits: ['Recurring revenue', 'Customer relationship'],
  },
];
...
export const carbonfootprintTool: UnifiedTool = {
  ...
  description:
    'Comprehensive carbon footprint calculation and analysis tool using GHG Protocol methodology. Supports emissions calculation (Scope 1/2/3), carbon offset analysis, lifecycle assessment (LCA), and reduction strategy planning.',
  parameters: {
    type: 'object',
    properties: {
      operation: {
        ...
        description:
          'Operation: calculate emissions, analyze offsets, run lifecycle assessment, plan reductions, compare scenarios, or get info',
      },
      ...
      emissions: {
        ...
        items: { type: 'object' },
        description:
          'List of emission sources and quantities. Each entry has: source (string, e.g., electricity_us_avg, gasoline), amount (number), unit (string, optional)',
      },
      ...
      product: {
        type: 'string',
        description: 'Product type for lifecycle assessment (e.g., smartphone, car_ev)',
      },
      ...
      scenarios: {
        ...
        items: { type: 'object' },
        description:
          'Scenarios to compare. Each scenario has: name (string), emissions (array of emission objects)',
      },
    },
    required: ['operation'],
  },
...
function analyzeOffsets(
  ...
  const scoredProjects = OFFSET_PROJECTS.map((project) => {
    ...
    switch (priority) {
      ...
      case 'permanence':
        ...
        score +=
          project.additionality === 'high' ? 50 : project.additionality === 'medium' ? 25 : 5;
        break;
      case 'cobenefits':
        score = project.cobenefits.length * 20;
        score +=
          project.additionality === 'high' ? 30 : project.additionality === 'medium' ? 15 : 5;
        break;
      case 'balanced':
      default:
        ...
        score +=
          project.additionality === 'high' ? 20 : project.additionality === 'medium' ? 10 : 3;
  ...
  for (const rec of recommendations) {
    ...
    permScore +=
      (rec.project.permanence === 'high' ? 3 : rec.project.permanence === 'medium' ? 2 : 1) *
      rec.tonnes_allocated;
    addScore +=
      (rec.project.additionality === 'high' ? 3 : rec.project.additionality === 'medium' ? 2 : 1) *
      rec.tonnes_allocated;
    riskScore +=
      (rec.project.riskLevel === 'high' ? 3 : rec.project.riskLevel === 'medium' ? 2 : 1) *
      rec.tonnes_allocated;
  }
...
function planReductions(
  ...
  const strategies = filteredStrategies.map((strategy) => {
    const [lowPct, highPct] = strategy.potentialReduction
      .split('-')
  ...
  return {
    ...
    pathway_summary: {
      ...
      timeline:
        totalLow >= reductionNeeded
          ? '1-3 years with aggressive action'
          : '3-5 years with sustained effort',
...
function compareScenarios(scenarios: Array<{ name: string; emissions: EmissionInput[] }>): {
  ...
  const differences = results.slice(1).map((r) => ({
    ...
    vs_baseline_percent:
      ((r.total_tonnesCO2e - baseline.total_tonnesCO2e) / baseline.total_tonnesCO2e) * 100,
  }));
...
function getInfo(): object {
  return {
    ...
    description:
      'Comprehensive carbon footprint calculation and analysis using GHG Protocol methodology',
    capabilities: [
...
export async function executecarbonfootprint(
