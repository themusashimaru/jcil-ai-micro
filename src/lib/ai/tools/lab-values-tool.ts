...
const labTests: Record<string, LabTestDefinition> = {
  ...
  'wbc': {
    ...
    category: 'CBC',
    referenceRanges: {
      adult: { low: 4.5, high: 11.0, criticalLow: 2.0, criticalHigh: 30.0, unit: 'x10^3/µL', siUnit: 'x10^9/L', siConversion: 1 }
    },
    ...
    clinicalSignificance: {
      ...
      low: ['Bone marrow suppression', 'Chemotherapy', 'Viral infection', 'Autoimmune disorders', 'Aplastic anemia']
    }
  },
  'rbc': {
    ...
    category: 'CBC',
    referenceRanges: {
      adult_male: { low: 4.5, high: 5.5, criticalLow: 2.0, criticalHigh: 7.0, unit: 'x10^6/µL', siUnit: 'x10^12/L', siConversion: 1 },
      adult_female: { low: 4.0, high: 5.0, criticalLow: 2.0, criticalHigh: 7.0, unit: 'x10^6/µL', siUnit: 'x10^12/L', siConversion: 1 }
    },
  ...
  'hemoglobin': {
    ...
    category: 'CBC',
    referenceRanges: {
      adult_male: { low: 13.5, high: 17.5, criticalLow: 7.0, criticalHigh: 20.0, unit: 'g/dL', siUnit: 'g/L', siConversion: 10 },
      adult_female: { low: 12.0, high: 16.0, criticalLow: 7.0, criticalHigh: 20.0, unit: 'g/dL', siUnit: 'g/L', siConversion: 10 }
    },
  ...
  'hematocrit': {
    ...
    category: 'CBC',
    referenceRanges: {
      adult_male: { low: 38.8, high: 50.0, criticalLow: 20.0, criticalHigh: 60.0, unit: '%', siUnit: 'L/L', siConversion: 0.01 },
      adult_female: { low: 34.9, high: 44.5, criticalLow: 20.0, criticalHigh: 60.0, unit: '%', siUnit: 'L/L', siConversion: 0.01 }
    },
  ...
  'platelets': {
    ...
    category: 'CBC',
    referenceRanges: {
      adult: { low: 150, high: 400, criticalLow: 50, criticalHigh: 1000, unit: 'x10^3/µL', siUnit: 'x10^9/L', siConversion: 1 }
    },
    description: 'Cell fragments essential for blood clotting',
    clinicalSignificance: {
      high: ['Reactive thrombocytosis', 'Essential thrombocythemia', 'Iron deficiency', 'Infection', 'Malignancy'],
      low: ['Thrombocytopenia', 'Bone marrow failure', 'ITP', 'DIC', 'Heparin-induced', 'Chemotherapy']
    }
  },
  'mcv': {
  ...
  'rdw': {
    ...
    clinicalSignificance: {
      high: ['Mixed anemia', 'Iron deficiency', 'B12/folate deficiency', 'Hemolysis', 'Reticulocytosis'],
  ...
  'glucose': {
    ...
    category: 'BMP',
    referenceRanges: {
      adult: { low: 70, high: 100, criticalLow: 40, criticalHigh: 500, unit: 'mg/dL', siUnit: 'mmol/L', siConversion: 0.0555 }
    },
    description: 'Blood sugar level (fasting)',
    clinicalSignificance: {
      high: ['Diabetes mellitus', 'Stress response', 'Pancreatitis', 'Cushing syndrome', 'Medications'],
  ...
  'bun': {
    ...
    category: 'BMP',
    referenceRanges: {
      adult: { low: 7, high: 20, criticalHigh: 100, unit: 'mg/dL', siUnit: 'mmol/L', siConversion: 0.357 }
    },
    description: 'Waste product from protein metabolism filtered by kidneys',
    clinicalSignificance: {
      high: ['Renal failure', 'Dehydration', 'GI bleeding', 'High protein diet', 'Catabolic states'],
  ...
  'creatinine': {
    ...
    category: 'BMP',
    referenceRanges: {
      adult_male: { low: 0.7, high: 1.3, criticalHigh: 10.0, unit: 'mg/dL', siUnit: 'µmol/L', siConversion: 88.4 },
      adult_female: { low: 0.6, high: 1.1, criticalHigh: 10.0, unit: 'mg/dL', siUnit: 'µmol/L', siConversion: 88.4 }
    },
  ...
  'sodium': {
    ...
    category: 'BMP',
    referenceRanges: {
      adult: { low: 136, high: 145, criticalLow: 120, criticalHigh: 160, unit: 'mEq/L', siUnit: 'mmol/L', siConversion: 1 }
    },
  ...
  'potassium': {
    ...
    category: 'BMP',
    referenceRanges: {
      adult: { low: 3.5, high: 5.0, criticalLow: 2.5, criticalHigh: 6.5, unit: 'mEq/L', siUnit: 'mmol/L', siConversion: 1 }
    },
    description: 'Major intracellular cation, critical for cardiac function',
    clinicalSignificance: {
      high: ['Renal failure', 'Acidosis', 'Tissue destruction', 'ACE inhibitors', 'K-sparing diuretics'],
  ...
  'chloride': {
    ...
    category: 'BMP',
    referenceRanges: {
      adult: { low: 98, high: 106, criticalLow: 80, criticalHigh: 120, unit: 'mEq/L', siUnit: 'mmol/L', siConversion: 1 }
    },
  ...
  'co2': {
    ...
    category: 'BMP',
    referenceRanges: {
      adult: { low: 22, high: 28, criticalLow: 10, criticalHigh: 40, unit: 'mEq/L', siUnit: 'mmol/L', siConversion: 1 }
    },
    ...
    clinicalSignificance: {
      ...
      low: ['Metabolic acidosis', 'Respiratory alkalosis (compensation)', 'Diarrhea', 'Renal failure']
    }
  },
  'calcium': {
    name: 'Calcium',
    ...
    category: 'BMP',
    referenceRanges: {
      adult: { low: 8.5, high: 10.5, criticalLow: 6.0, criticalHigh: 14.0, unit: 'mg/dL', siUnit: 'mmol/L', siConversion: 0.25 }
    },
    description: 'Important for bone health, muscle function, and nerve conduction',
    clinicalSignificance: {
      high: ['Hyperparathyroidism', 'Malignancy', 'Vitamin D toxicity', 'Thiazides', 'Immobilization'],
      low: ['Hypoparathyroidism', 'Vitamin D deficiency', 'Chronic kidney disease', 'Pancreatitis', 'Hypomagnesemia']
    }
  },
  ...
  'bilirubin_total': {
    ...
    category: 'LFT',
    referenceRanges: {
      adult: { low: 0.1, high: 1.2, criticalHigh: 15.0, unit: 'mg/dL', siUnit: 'µmol/L', siConversion: 17.1 }
    },
    description: 'Product of hemoglobin breakdown',
    clinicalSignificance: {
      high: ['Hemolysis', 'Liver disease', 'Biliary obstruction', 'Gilbert syndrome', 'Ineffective erythropoiesis'],
      low: ['Generally not clinically significant']
    }
  },
  'bilirubin_direct': {
  ...
  'albumin': {
    ...
    category: 'LFT',
    referenceRanges: {
      adult: { low: 3.5, high: 5.0, criticalLow: 1.5, unit: 'g/dL', siUnit: 'g/L', siConversion: 10 }
    },
    description: 'Major plasma protein synthesized by liver',
    clinicalSignificance: {
      high: ['Dehydration'],
      low: ['Liver disease', 'Malnutrition', 'Nephrotic syndrome', 'Burns', 'Sepsis', 'Protein-losing enteropathy']
    }
  },
  'total_protein': {
    name: 'Total Protein',
  ...
  'cholesterol_total': {
    ...
    clinicalSignificance: {
      high: ['Hyperlipidemia', 'Cardiovascular risk', 'Hypothyroidism', 'Nephrotic syndrome', 'Diet'],
  ...
  'hdl': {
    ...
    clinicalSignificance: {
      ...
      low: ['Cardiovascular risk', 'Metabolic syndrome', 'Smoking', 'Obesity', 'Sedentary lifestyle']
    }
  },
  'triglycerides': {
    name: 'Triglycerides',
    ...
    category: 'Lipid',
    referenceRanges: {
      adult: { low: 0, high: 150, criticalHigh: 500, unit: 'mg/dL', siUnit: 'mmol/L', siConversion: 0.0113 }
    },
    description: 'Fat in the blood',
    clinicalSignificance: {
      high: ['Cardiovascular risk', 'Metabolic syndrome', 'Diabetes', 'Alcohol', 'Diet', 'Pancreatitis risk >500'],
  ...
  'tsh': {
    ...
    clinicalSignificance: {
      ...
      low: ['Hyperthyroidism', 'Secondary hypothyroidism', 'Sick euthyroid syndrome', 'Medications']
    }
  },
  'free_t4': {
    name: 'Free Thyroxine',
  ...
  'pt': {
    ...
    clinicalSignificance: {
      high: ['Warfarin therapy', 'Liver disease', 'Vitamin K deficiency', 'DIC', 'Factor deficiency'],
  ...
  'inr': {
    ...
    clinicalSignificance: {
      high: ['Anticoagulation (therapeutic 2-3 for most indications)', 'Liver disease', 'Vitamin K deficiency', 'DIC'],
      low: ['Generally not clinically significant']
    }
  },
  'ptt': {
    ...
    clinicalSignificance: {
      high: ['Heparin therapy', 'Hemophilia', 'vWD', 'Lupus anticoagulant', 'Factor deficiency', 'DIC'],
      low: ['Generally not clinically significant']
    }
  },
  'd_dimer': {
  ...
  'fibrinogen': {
    ...
    category: 'Coagulation',
    referenceRanges: {
      adult: { low: 200, high: 400, criticalLow: 100, unit: 'mg/dL', siUnit: 'g/L', siConversion: 0.01 }
    },
  ...
  'troponin_i': {
    ...
    clinicalSignificance: {
      high: ['Acute MI', 'Myocarditis', 'PE', 'Heart failure', 'Sepsis', 'Renal failure', 'Cardiac contusion'],
      low: ['Normal']
    }
  },
  'bnp': {
  ...
  'ck_mb': {
    ...
    clinicalSignificance: {
      high: ['Acute MI', 'Cardiac surgery', 'Myocarditis', 'Rhabdomyolysis with cardiac involvement'],
      low: ['Normal']
    }
  },
  ...
  'esr': {
    ...
    clinicalSignificance: {
      high: ['Infection', 'Inflammation', 'Malignancy', 'Autoimmune disease', 'Anemia', 'Advanced age'],
  ...
  'magnesium': {
    ...
    category: 'Metabolic',
    referenceRanges: {
      adult: { low: 1.7, high: 2.2, criticalLow: 1.0, criticalHigh: 4.0, unit: 'mg/dL', siUnit: 'mmol/L', siConversion: 0.411 }
    },
  ...
  'phosphorus': {
    ...
    category: 'Metabolic',
    referenceRanges: {
      adult: { low: 2.5, high: 4.5, criticalLow: 1.0, unit: 'mg/dL', siUnit: 'mmol/L', siConversion: 0.323 }
    },
    ...
    clinicalSignificance: {
      ...
      low: ['Refeeding syndrome', 'Alcoholism', 'Hyperparathyroidism', 'Vitamin D deficiency', 'Antacids']
    }
  },
  'hba1c': {
    name: 'Hemoglobin A1c',
...
const panels: Record<string, string[]> = {
  ...
  'cmp': ['glucose', 'bun', 'creatinine', 'sodium', 'potassium', 'chloride', 'co2', 'calcium', 'alt', 'ast', 'alp', 'bilirubin_total', 'albumin', 'total_protein'],
  'lft': ['alt', 'ast', 'alp', 'ggt', 'bilirubin_total', 'bilirubin_direct', 'albumin', 'total_protein'],
...
class LabValueInterpreter {
  ...
  calculateAnionGap(sodium: number, chloride: number, bicarbonate: number): AnionGapResult {
    ...
    if (ag >= 8 && ag <= 12) {
      ...
      acidosisType = 'Consider: Ketoacidosis (DKA, alcoholic, starvation), Lactic acidosis, Uremia, Toxins (methanol, ethylene glycol, salicylate)';
    } else {
      interpretation = 'Low anion gap - may indicate hypoalbuminemia, multiple myeloma, or lab error';
    }
  ...
  calculateBunCreatinineRatio(bun: number, creatinine: number): BunCreatinineRatioResult {
    ...
    if (ratio >= 10 && ratio <= 20) {
      ...
      interpretation = 'Elevated ratio - consider: GI bleeding, dehydration, high protein diet, catabolic state, post-renal obstruction';
    } else {
  ...
  assessAnemiaType(mcv: number, mchc: number): { type: string; differentials: string[] } {
    ...
    if (mcv < 80) {
      ...
      differentials = ['B12 deficiency', 'Folate deficiency', 'Liver disease', 'Hypothyroidism', 'MDS', 'Medications'];
    } else {
      type = 'Normocytic anemia';
      differentials = ['Acute blood loss', 'Chronic disease', 'Renal failure', 'Hemolysis', 'Mixed deficiency'];
    }
  ...
  convertUnits(testKey: string, value: number, toSI: boolean): { value: number; unit: string } | null {
    const test = labTests[testKey.toLowerCase()];
    if (!test) return null;

    const range = test.referenceRanges.adult ||
  ...
  analyzePanel(panelName: string, values: Record<string, number>, gender?: 'male' | 'female'): {
    ...
    if (!panelTests) {
      return { results: [], summary: `Unknown panel: ${panelName}`, abnormalCount: 0, criticalCount: 0 };
    }
  ...
  analyzeTrend(values: { value: number; date: string }[], testKey: string): {
    trend: 'increasing' | 'decreasing' | 'stable' | 'fluctuating';
    percentChange: number;
    interpretation: string;
  } {
    if (values.length < 2) {
      return { trend: 'stable', percentChange: 0, interpretation: 'Insufficient data for trend analysis' };
    }
...
- examples: Usage examples`,
  parameters: {
    ...
    properties: {
      operation: {
        type: 'string',
        enum: ['interpret', 'panel', 'convert', 'calculate', 'anemia', 'trend', 'lookup', 'list_tests', 'list_panels', 'info', 'examples'],
      ...
      panel: {
        type: 'string',
        enum: ['cbc', 'bmp', 'cmp', 'lft', 'lipid', 'thyroid', 'coagulation', 'cardiac', 'iron_studies'],
      ...
      serial_values: {
        ...
        description: 'Array of values with dates for trend analysis'
      },
      category: {
        type: 'string',
  ...
  try {
    ...
    switch (operation) {
      case 'interpret': {
        ...
        return {
          ...
          content: JSON.stringify({
            operation: 'interpret',
            result,
            alert: result.status.startsWith('critical') ? 'CRITICAL VALUE - IMMEDIATE ATTENTION REQUIRED' : undefined
          }, null, 2)
        };
      }
      ...
      case 'panel': {
        ...
        return {
          ...
          content: JSON.stringify({
            ...
            alert: result.criticalCount > 0 ? 'CRITICAL VALUES PRESENT - IMMEDIATE ATTENTION REQUIRED' : undefined
          }, null, 2)
        };
      }
      ...
      case 'convert': {
        ...
        const range = testDef?.referenceRanges.adult || Object.values(testDef?.referenceRanges || {})[0];
        ...
        switch (calculation) {
          case 'anion_gap': {
            ...
            if (sodium === undefined || chloride === undefined || co2 === undefined) {
              return { toolCallId: id, content: 'Error: sodium, chloride, and co2 values are required', isError: true };
            }
          ...
          case 'bun_cr_ratio': {
            ...
            if (bun === undefined || creatinine === undefined) {
              return { toolCallId: id, content: 'Error: bun and creatinine values are required', isError: true };
            }
          ...
          case 'ast_alt_ratio': {
            ...
            if (ast === undefined || alt === undefined) {
              return { toolCallId: id, content: 'Error: ast and alt values are required', isError: true };
            }
      ...
      case 'trend': {
        ...
        if (!test || !serialValues || serialValues.length < 2) {
          return { toolCallId: id, content: 'Error: test and at least 2 serial_values are required', isError: true };
        }
      ...
      case 'list_panels': {
        const panelInfo: Record<string, { tests: string[]; description: string }> = {
          cbc: { tests: panels.cbc, description: 'Complete Blood Count - Red and white blood cell indices' },
          bmp: { tests: panels.bmp, description: 'Basic Metabolic Panel - Electrolytes and kidney function' },
          cmp: { tests: panels.cmp, description: 'Comprehensive Metabolic Panel - BMP plus liver function' },
          lft: { tests: panels.lft, description: 'Liver Function Tests - Hepatic enzymes and proteins' },
          lipid: { tests: panels.lipid, description: 'Lipid Panel - Cholesterol and triglycerides' },
          thyroid: { tests: panels.thyroid, description: 'Thyroid Function - TSH and thyroid hormones' },
          coagulation: { tests: panels.coagulation, description: 'Coagulation Studies - Clotting factors and times' },
          cardiac: { tests: panels.cardiac, description: 'Cardiac Markers - Heart damage indicators' },
          iron_studies: { tests: panels.iron_studies, description: 'Iron Studies - Iron stores and transport' }
        };
      ...
      case 'info': {
        return {
          ...
          content: JSON.stringify({
            ...
            disclaimer: 'This tool is for educational purposes only. All results should be interpreted by qualified healthcare professionals in clinical context.'
          }, null, 2)
        };
      }
            ...
            examples: [
              {
                ...
                call: { operation: 'interpret', test: 'hemoglobin', value: 10.5, gender: 'female' }
              },
              {
                ...
                call: {
                  operation: 'panel',
                  panel: 'cbc',
                  values: { wbc: 12.5, rbc: 4.2, hemoglobin: 12.0, hematocrit: 36, platelets: 250, mcv: 85 },
                  gender: 'female'
                }
              },
              {
