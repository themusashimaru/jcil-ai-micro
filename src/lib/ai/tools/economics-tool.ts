...
export function gdpGrowthRate(gdpCurrent: number, gdpPrevious: number): number {
...
export function laborForceParticipation(laborForce: number, workingAgePopulation: number): number {
