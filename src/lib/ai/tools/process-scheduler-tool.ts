 ...
 * Process scheduling algorithms FCFS RR SJF
 */
...
export const processschedulerTool: UnifiedTool = {
  ...
  description: 'Process scheduling algorithms FCFS RR SJF',
  parameters: {
    type: 'object',
    properties: {
...
export async function executeprocessscheduler(toolCall: UnifiedToolCall): Promise<UnifiedToolResult> {
  ...
  try {
    ...
    const result = { operation: args.operation, tool: 'process-scheduler', scheduled: true };
