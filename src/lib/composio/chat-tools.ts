...
import {
  sortByCanvaPriority,
  getCanvaSystemPrompt,
  logCanvaToolkitStats,
  getCanvaCapabilitySummary,
} from './canva-toolkit';
import {
  sortByWordPressPriority,
  getWordPressSystemPrompt,
  logWordPressToolkitStats,
  getWordPressCapabilitySummary,
} from './wordpress-toolkit';
import {
  sortByPayPalPriority,
  getPayPalSystemPrompt,
  logPayPalToolkitStats,
  getPayPalCapabilitySummary,
} from './paypal-toolkit';
import {
  sortByOneDrivePriority,
  getOneDriveSystemPrompt,
  logOneDriveToolkitStats,
  getOneDriveCapabilitySummary,
} from './onedrive-toolkit';
import {
  sortByXeroPriority,
  getXeroSystemPrompt,
  logXeroToolkitStats,
  getXeroCapabilitySummary,
} from './xero-toolkit';
import {
  sortByEventbritePriority,
  getEventbriteSystemPrompt,
  logEventbriteToolkitStats,
  getEventbriteCapabilitySummary,
} from './eventbrite-toolkit';
import {
  sortByKlaviyoPriority,
  getKlaviyoSystemPrompt,
  logKlaviyoToolkitStats,
  getKlaviyoCapabilitySummary,
} from './klaviyo-toolkit';
import {
  sortByActiveCampaignPriority,
  getActiveCampaignSystemPrompt,
  logActiveCampaignToolkitStats,
  getActiveCampaignCapabilitySummary,
} from './activecampaign-toolkit';
import {
  sortByBambooHRPriority,
  getBambooHRSystemPrompt,
  logBambooHRToolkitStats,
  getBambooHRCapabilitySummary,
} from './bamboohr-toolkit';
import {
  sortByHelpScoutPriority,
  getHelpScoutSystemPrompt,
  logHelpScoutToolkitStats,
  getHelpScoutCapabilitySummary,
} from './helpscout-toolkit';
import {
  sortBySquarePriority,
  getSquareSystemPrompt,
  logSquareToolkitStats,
  getSquareCapabilitySummary,
} from './square-toolkit';
import {
  sortByFreshBooksPriority,
  getFreshBooksSystemPrompt,
  logFreshBooksToolkitStats,
  getFreshBooksCapabilitySummary,
} from './freshbooks-toolkit';
import {
  sortByPandaDocPriority,
  getPandaDocSystemPrompt,
  logPandaDocToolkitStats,
  getPandaDocCapabilitySummary,
} from './pandadoc-toolkit';
import {
  sortBySpotifyPriority,
  getSpotifySystemPrompt,
  logSpotifyToolkitStats,
  getSpotifyCapabilitySummary,
} from './spotify-toolkit';
import {
  sortByMixpanelPriority,
  getMixpanelSystemPrompt,
  logMixpanelToolkitStats,
  getMixpanelCapabilitySummary,
} from './mixpanel-toolkit';
import {
  sortByMiroPriority,
  getMiroSystemPrompt,
  logMiroToolkitStats,
  getMiroCapabilitySummary,
} from './miro-toolkit';
import {
  sortByWixPriority,
  getWixSystemPrompt,
  logWixToolkitStats,
  getWixCapabilitySummary,
} from './wix-toolkit';
import {
  sortByGumroadPriority,
  getGumroadSystemPrompt,
  logGumroadToolkitStats,
  getGumroadCapabilitySummary,
} from './gumroad-toolkit';
import {
  sortBySegmentPriority,
  getSegmentSystemPrompt,
  logSegmentToolkitStats,
  getSegmentCapabilitySummary,
} from './segment-toolkit';
import {
...
const TOOLKIT_REGISTRY: ToolkitIntegration[] = [
  ...
  },
  {
    id: 'CANVA',
    displayName: 'Canva',
    prefix: 'composio_CANVA_',
    cap: 500,
    appMatchers: ['canva'],
    sortFn: sortByCanvaPriority,
    systemPromptFn: getCanvaSystemPrompt,
    logStatsFn: logCanvaToolkitStats,
    capabilitySummaryFn: getCanvaCapabilitySummary,
  },
  {
    id: 'WORDPRESS',
    displayName: 'WordPress',
    prefix: 'composio_WORDPRESS_',
    cap: 500,
    appMatchers: ['wordpress'],
    sortFn: sortByWordPressPriority,
    systemPromptFn: getWordPressSystemPrompt,
    logStatsFn: logWordPressToolkitStats,
    capabilitySummaryFn: getWordPressCapabilitySummary,
  },
  {
    id: 'PAYPAL',
    displayName: 'PayPal',
    prefix: 'composio_PAYPAL_',
    cap: 500,
    appMatchers: ['paypal'],
    sortFn: sortByPayPalPriority,
    systemPromptFn: getPayPalSystemPrompt,
    logStatsFn: logPayPalToolkitStats,
    capabilitySummaryFn: getPayPalCapabilitySummary,
  },
  {
    id: 'ONEDRIVE',
    displayName: 'OneDrive',
    prefix: 'composio_ONEDRIVE_',
    cap: 500,
    appMatchers: ['onedrive', 'microsoftonedrive'],
    sortFn: sortByOneDrivePriority,
    systemPromptFn: getOneDriveSystemPrompt,
    logStatsFn: logOneDriveToolkitStats,
    capabilitySummaryFn: getOneDriveCapabilitySummary,
  },
  {
    id: 'XERO',
    displayName: 'Xero',
    prefix: 'composio_XERO_',
    cap: 500,
    appMatchers: ['xero'],
    sortFn: sortByXeroPriority,
    systemPromptFn: getXeroSystemPrompt,
    logStatsFn: logXeroToolkitStats,
    capabilitySummaryFn: getXeroCapabilitySummary,
  },
  {
    id: 'EVENTBRITE',
    displayName: 'Eventbrite',
    prefix: 'composio_EVENTBRITE_',
    cap: 500,
    appMatchers: ['eventbrite'],
    sortFn: sortByEventbritePriority,
    systemPromptFn: getEventbriteSystemPrompt,
    logStatsFn: logEventbriteToolkitStats,
    capabilitySummaryFn: getEventbriteCapabilitySummary,
  },
  {
    id: 'KLAVIYO',
    displayName: 'Klaviyo',
    prefix: 'composio_KLAVIYO_',
    cap: 500,
    appMatchers: ['klaviyo'],
    sortFn: sortByKlaviyoPriority,
    systemPromptFn: getKlaviyoSystemPrompt,
    logStatsFn: logKlaviyoToolkitStats,
    capabilitySummaryFn: getKlaviyoCapabilitySummary,
  },
  {
    id: 'ACTIVECAMPAIGN',
    displayName: 'ActiveCampaign',
    prefix: 'composio_ACTIVECAMPAIGN_',
    cap: 500,
    appMatchers: ['activecampaign'],
    sortFn: sortByActiveCampaignPriority,
    systemPromptFn: getActiveCampaignSystemPrompt,
    logStatsFn: logActiveCampaignToolkitStats,
    capabilitySummaryFn: getActiveCampaignCapabilitySummary,
  },
  {
    id: 'BAMBOOHR',
    displayName: 'BambooHR',
    prefix: 'composio_BAMBOOHR_',
    cap: 500,
    appMatchers: ['bamboohr'],
    sortFn: sortByBambooHRPriority,
    systemPromptFn: getBambooHRSystemPrompt,
    logStatsFn: logBambooHRToolkitStats,
    capabilitySummaryFn: getBambooHRCapabilitySummary,
  },
  {
    id: 'HELPSCOUT',
    displayName: 'Help Scout',
    prefix: 'composio_HELPSCOUT_',
    cap: 500,
    appMatchers: ['helpscout', 'help_scout'],
    sortFn: sortByHelpScoutPriority,
    systemPromptFn: getHelpScoutSystemPrompt,
    logStatsFn: logHelpScoutToolkitStats,
    capabilitySummaryFn: getHelpScoutCapabilitySummary,
  },
  {
    id: 'SQUARE',
    displayName: 'Square',
    prefix: 'composio_SQUARE_',
    cap: 500,
    appMatchers: ['square'],
    sortFn: sortBySquarePriority,
    systemPromptFn: getSquareSystemPrompt,
    logStatsFn: logSquareToolkitStats,
    capabilitySummaryFn: getSquareCapabilitySummary,
  },
  {
    id: 'FRESHBOOKS',
    displayName: 'FreshBooks',
    prefix: 'composio_FRESHBOOKS_',
    cap: 500,
    appMatchers: ['freshbooks'],
    sortFn: sortByFreshBooksPriority,
    systemPromptFn: getFreshBooksSystemPrompt,
    logStatsFn: logFreshBooksToolkitStats,
    capabilitySummaryFn: getFreshBooksCapabilitySummary,
  },
  {
    id: 'PANDADOC',
    displayName: 'PandaDoc',
    prefix: 'composio_PANDADOC_',
    cap: 500,
    appMatchers: ['pandadoc'],
    sortFn: sortByPandaDocPriority,
    systemPromptFn: getPandaDocSystemPrompt,
    logStatsFn: logPandaDocToolkitStats,
    capabilitySummaryFn: getPandaDocCapabilitySummary,
  },
  {
    id: 'SPOTIFY',
    displayName: 'Spotify',
    prefix: 'composio_SPOTIFY_',
    cap: 500,
    appMatchers: ['spotify'],
    sortFn: sortBySpotifyPriority,
    systemPromptFn: getSpotifySystemPrompt,
    logStatsFn: logSpotifyToolkitStats,
    capabilitySummaryFn: getSpotifyCapabilitySummary,
  },
  {
    id: 'MIXPANEL',
    displayName: 'Mixpanel',
    prefix: 'composio_MIXPANEL_',
    cap: 500,
    appMatchers: ['mixpanel'],
    sortFn: sortByMixpanelPriority,
    systemPromptFn: getMixpanelSystemPrompt,
    logStatsFn: logMixpanelToolkitStats,
    capabilitySummaryFn: getMixpanelCapabilitySummary,
  },
  {
    id: 'MIRO',
    displayName: 'Miro',
    prefix: 'composio_MIRO_',
    cap: 500,
    appMatchers: ['miro'],
    sortFn: sortByMiroPriority,
    systemPromptFn: getMiroSystemPrompt,
    logStatsFn: logMiroToolkitStats,
    capabilitySummaryFn: getMiroCapabilitySummary,
  },
  {
    id: 'WIX',
    displayName: 'Wix',
    prefix: 'composio_WIX_',
    cap: 500,
    appMatchers: ['wix'],
    sortFn: sortByWixPriority,
    systemPromptFn: getWixSystemPrompt,
    logStatsFn: logWixToolkitStats,
    capabilitySummaryFn: getWixCapabilitySummary,
  },
  {
    id: 'GUMROAD',
    displayName: 'Gumroad',
    prefix: 'composio_GUMROAD_',
    cap: 500,
    appMatchers: ['gumroad'],
    sortFn: sortByGumroadPriority,
    systemPromptFn: getGumroadSystemPrompt,
    logStatsFn: logGumroadToolkitStats,
    capabilitySummaryFn: getGumroadCapabilitySummary,
  },
  {
    id: 'SEGMENT',
    displayName: 'Segment',
    prefix: 'composio_SEGMENT_',
    cap: 500,
    appMatchers: ['segment'],
    sortFn: sortBySegmentPriority,
    systemPromptFn: getSegmentSystemPrompt,
    logStatsFn: logSegmentToolkitStats,
    capabilitySummaryFn: getSegmentCapabilitySummary,
  },
  {
    id: 'VERCEL',
    displayName: 'Vercel',
