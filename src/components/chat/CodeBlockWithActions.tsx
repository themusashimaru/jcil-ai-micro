...
export function CodeBlockWithActions({
  ...
  return (
    <div className="rounded-lg overflow-hidden my-2" style={{ backgroundColor: 'var(--glass-bg)' }}>
        ...
        <div className="flex items-center gap-1">
          ...
          >
            {copied ? (
              ...
              <CopyIcon className="w-4 h-4" style={{ color: 'var(--text-muted)' }} />
            )}
          </button>
          ...
          {showTestButton && canTest && onTest && (
            ...
            >
              {testing ? (
                ...
                <PlayIcon className="w-4 h-4" style={{ color: 'var(--text-muted)' }} />
              )}
            </button>
          )}
      ...
      {testResult && (
        <div
          className="px-3 py-2 border-t text-xs font-mono"
          style={{
            borderColor: 'var(--border)',
...
function LanguageIcon({ language }: { language: string }) {
  ...
  if (lang === 'python' || lang === 'py') {
    return (
      <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor" style={{ color: '#3776ab' }}>
