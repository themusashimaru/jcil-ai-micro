...
export default function MultiPagePreview({
  ...
  const applyEdit = useCallback(() => {
    ...
    // Note: html variable reserved for future DOM manipulation
    // Currently using AI to regenerate with the edit
    void updatedPages[currentPage].code; // Reference to suppress unused warning
