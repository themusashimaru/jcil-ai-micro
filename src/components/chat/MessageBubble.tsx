...
export const MessageBubble = memo(
          ...
          {message.attachments && message.attachments.length > 0 && (
            <div className="flex flex-wrap gap-2 max-w-full overflow-hidden">
              {message.attachments.map((attachment) => {
                ...
                const isText =
                  attachment.type === 'text/plain' || attachment.name?.endsWith('.txt');
                    ...
                    return (
                      ...
                      >
                        ...
                        <button
                          ...
                          onClick={() =>
                            handleSaveToMyFiles(index, file.download_url, file.filename)
                          }
                        >
  ...
  function areEqual(prev, next) {
    // Custom comparator: skip re-render if message content hasn't changed
    return (
