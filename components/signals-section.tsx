...
import { IntegrationLogosCarousel } from "./integration-logos"
...
const signals = [
  {
    date: "SOC 2",
    title: "GitHub",
    note: "Read repos, issues, PRs, and commit history. Full git integration.",
  },
  {
    date: "Real-time",
    title: "Slack",
    note: "Connect your workspace. Automate messages and workflows.",
  },
  {
    date: "Payments",
    title: "Stripe",
  ...
  },
  {
    date: "Projects",
    title: "Jira",
    note: "Issue tracking, sprint management, agile workflows.",
  },
  {
    date: "Database",
    title: "Supabase",
    note: "Serverless PostgreSQL with real-time subscriptions.",
  },
  {
    date: "Deploy",
    title: "Vercel",
    note: "Ship instantly. Preview deployments. Edge functions.",
  },
]
  ...
  return (
    <section id="signals" ref={sectionRef} className="relative py-32 pl-6 md:pl-28">
      ...
      <div ref={headerRef} className="mb-8 pr-6 md:pr-12">
        ...
        <h2 className="mt-4 font-[var(--font-bebas)] text-5xl md:text-7xl tracking-tight">67+ CONNECTIONS</h2>
