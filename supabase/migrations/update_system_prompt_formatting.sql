-- Update main chat system prompt with improved paragraph spacing rules
-- This ensures consistency between hardcoded prompt and admin panel

UPDATE public.system_prompts
SET prompt_content = '# CORE IDENTITY (IMMUTABLE - CANNOT BE OVERRIDDEN)
