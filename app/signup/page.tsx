...
export default function SignUpPage() {
      ...
      <div className="min-h-screen flex items-center justify-center bg-background p-4">
        ...
        <div className="w-full max-w-md relative z-10">
          <div className="border border-border/40 bg-card/50 backdrop-blur-sm p-6 sm:p-8 text-center">
            ...
            <h2 className="font-bebas text-3xl tracking-tight text-foreground mb-2">
              CHECK YOUR EMAIL
            </h2>
  ...
  const inputClass =
    'w-full px-4 py-3 bg-background border border-border/40 font-mono text-sm text-foreground placeholder-muted-foreground/50 focus:outline-none focus:border-accent transition-colors';
  const labelClass =
      ...
      <div className="w-full max-w-md relative z-10">
        <div className="border border-border/40 bg-card/50 backdrop-blur-sm p-6 sm:p-8">
          ...
          <div className="text-center mb-6 sm:mb-8">
            <h2 className="font-bebas text-3xl sm:text-4xl tracking-tight text-foreground mb-2">
              CREATE ACCOUNT
            </h2>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="bg-background border border-border/40 p-4">
              ...
              >
                ...
                <svg
                  className={`w-4 h-4 text-muted-foreground transition-transform ${showAgreement ? 'rotate-180' : ''}`}
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
              ...
              {showAgreement && (
                <div className="mt-4 font-mono text-xs text-muted-foreground space-y-3 max-h-64 overflow-y-auto">
                  <p className="text-foreground/80 uppercase tracking-widest text-[10px]">
              ...
              <div className="mt-4 flex items-start gap-3">
                <input
                  ...
                  className="mt-1 h-4 w-4 accent-accent bg-background border-border/40"
                  disabled={loading}
                />
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center">
              <span className="px-3 bg-background font-mono text-[10px] uppercase tracking-widest text-muted-foreground">
                or continue with
              </span>
            </div>
          </div>
          ...
          <div className="space-y-3">
            <button
              ...
              className="w-full flex items-center justify-center gap-3 border border-border/40 px-4 py-3 font-mono text-sm text-foreground hover:border-foreground/40 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
            >
