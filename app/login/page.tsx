      ...
      <div className="w-full max-w-md relative z-10">
        <div className="border border-border/40 bg-card/50 backdrop-blur-sm p-6 sm:p-8">
          ...
          <div className="text-center mb-6 sm:mb-8">
            <h2 className="font-bebas text-3xl sm:text-4xl tracking-tight text-foreground mb-2">WELCOME BACK</h2>
            <p className="font-mono text-xs text-muted-foreground uppercase tracking-widest">Sign in to continue</p>
          </div>
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  placeholder="••••••••"
                  className="w-full px-4 py-3 pr-12 bg-background border border-border/40 font-mono text-sm text-foreground placeholder-muted-foreground/50 focus:outline-none focus:border-accent transition-colors"
                  disabled={loading}
                  required
                />
                <button
          ...
          {passkeySupported && (
            <div className="mt-3">
              <PasskeyLoginButton
                ...
                className="border-border/40 text-foreground hover:border-foreground/40"
              />
            </div>
          )}
