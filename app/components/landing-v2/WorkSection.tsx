...
const experiments = [
  {
    ...
    medium: "Code Lab",
    description: "Like Claude Code — but for every model. Switch between Claude, GPT, Gemini, Grok, and DeepSeek with a keystroke. File browser, git, terminal — in your browser.",
    span: "col-span-2 row-span-2",
  },
  {
    title: "Deep Strategy",
    medium: "AI Agent",
    description: "Up to 100 parallel research scouts. Opus architect. Full strategic analysis.",
    span: "col-span-1 row-span-1",
  },
  {
    title: "E2B Sandbox",
    medium: "Code Execution",
    description: "Run Python, JavaScript, and terminal commands in isolated containers. Your code executes safely.",
    span: "col-span-1 row-span-2",
  },
  {
    title: "FLUX.2",
    medium: "Image Gen",
    description: "Create images from natural language with state-of-the-art models.",
    span: "col-span-1 row-span-1",
  },
  {
    title: "Document Gen",
    medium: "Enterprise",
    description: "Word docs, Excel with formulas, PDFs, PowerPoints. Invoices, contracts, reports — from a single prompt.",
    span: "col-span-2 row-span-1",
  },
  {
    title: "Memory",
    medium: "Persistent",
    description: "JCIL remembers you across sessions. Preferences, facts, relationships — stored securely.",
    span: "col-span-1 row-span-1",
  },
];
    ...
    <section ref={sectionRef} id="capabilities" className="relative py-32 pl-6 md:pl-28 pr-6 md:pr-12">
      <div ref={headerRef} className="mb-16 flex items-end justify-between">
        <div>
          ...
          <h2 className="mt-4 font-bebas text-5xl md:text-7xl tracking-tight">WHAT SETS JCIL APART</h2>
        </div>
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10">
        ...
        <h3 className={cn("mt-3 font-bebas text-2xl md:text-4xl tracking-tight transition-colors duration-300", isActive ? "text-accent" : "text-foreground")}>
          {experiment.title}
        </h3>
      </div>
      <div className="relative z-10">
