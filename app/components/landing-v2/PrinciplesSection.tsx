...
const principles = [
  {
    ...
    description:
      'Like the Bereans in Acts 17:11, we test everything against Scripture. Our AI is grounded in Biblical truth — not cultural trends, not political winds, not popular opinion.',
    align: 'left' as const,
  },
  {
    number: '02',
    ...
    description:
      'Zero tolerance for profanity, blasphemy, and explicit content. Built so you can hand it to your teenager, your small group, or your church staff.',
  ...
  },
  {
    ...
    description:
      'API keys encrypted at rest with AES-256. Row-level security. 6-month hard deletion. Redis rate limiting. CSRF protection. Full audit trails.',
    align: 'left' as const,
  },
  {
    number: '04',
    ...
    description:
      'Your data is never used for training. End-to-end encryption. Full data export and deletion on request. We exist to serve you, not exploit you.',
    align: 'right' as const,
  },
];
    ...
    >
      <div ref={headerRef} className="mb-24">
        ...
        <p className="mt-6 max-w-2xl font-mono text-sm text-muted-foreground leading-relaxed">
          Every AI platform reflects the values of whoever built it. We chose to build one that
          reflects ours — and yours.
          <span className="block mt-4 text-foreground/80 italic">
