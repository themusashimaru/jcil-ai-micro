...
export function ColophonSection() {
  ...
  return (
    <section ref={sectionRef} id="colophon" className="relative py-32 pl-6 md:pl-28 pr-6 md:pr-12 border-t border-border/30">
      ...
      <div ref={gridRef} className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-8 md:gap-12">
        ...
        <div className="col-span-1">
          ...
          <ul className="space-y-2">
            ...
            <li className="font-mono text-[10px] text-muted-foreground mt-3 uppercase tracking-wider">BYOK Support:</li>
        ...
        <div className="col-span-1">
          <h4 className="font-mono text-[9px] uppercase tracking-[0.3em] text-muted-foreground mb-4">Key Integrations</h4>
          <ul className="space-y-2">
        ...
        <div className="col-span-1">
          <h4 className="font-mono text-[9px] uppercase tracking-[0.3em] text-muted-foreground mb-4">Built For</h4>
          <ul className="space-y-2">
        ...
        <div className="col-span-1">
          ...
          <ul className="space-y-2">
            <li><a href="mailto:support@jcil.ai" className="font-mono text-xs text-foreground/80 hover:text-accent transition-colors duration-200">support@jcil.ai</a></li>
            <li><a href="/chat" className="font-mono text-xs text-foreground/80 hover:text-accent transition-colors duration-200">Try JCIL.AI</a></li>
          </ul>
        </div>
      ...
      <div className="mt-16 flex flex-wrap gap-4">
        <a href="/chat" className="inline-flex items-center gap-3 border border-accent bg-accent/10 px-8 py-4 font-mono text-sm uppercase tracking-widest text-accent hover:bg-accent/20 transition-all duration-200">
          Start Free — No Credit Card
        </a>
        <a href="/code-lab" className="inline-flex items-center gap-3 border border-foreground/20 px-8 py-4 font-mono text-sm uppercase tracking-widest text-foreground hover:border-foreground/40 transition-all duration-200">
          Explore Code Lab
        </a>
      </div>
      ...
      <div ref={footerRef} className="mt-24 pt-8 border-t border-border/20 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        ...
        <p className="font-mono text-[10px] text-muted-foreground">AI that shares your values. Built with conviction.</p>
      </div>
    </section>
  );
}
