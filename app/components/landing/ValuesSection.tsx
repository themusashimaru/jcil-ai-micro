 ...
 * and why this platform exists. Not preachy — professional and clear.
 * Answers the "why not ChatGPT?" question directly.
 */
...
export default function ValuesSection() {
  return (
    <Section id="values" padding="lg" background="gradient">
      <SectionHeader
      ...
      <div className="max-w-5xl mx-auto">
        ...
        {/* Why not the others? */}
        <div className="rounded-2xl border border-amber-500/20 bg-amber-500/5 p-8 lg:p-10">
