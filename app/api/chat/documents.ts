/**
 * Chat Document Detection & Generation
 *
 * Handles document intent detection, subtype classification,
 * schema prompt generation, and document response formatting.
 * All functions are pure — no external dependencies or side effects.
 */
 ...
 */
export function detectDocumentSubtype(documentType: string, userMessage: string): string {
 ...
 */
export function extractPreviousDocumentContext(
 ...
 */
export function detectStyleMatchRequest(
  message: string,
  conversationHistory?: Array<{ role: string; content: unknown }>
 ...
 */
export function generateStyleMatchInstructions(uploadedFileContent: string): string {
 ...
 */
export function detectMultiDocumentRequest(
  message: string,
  conversationHistory?: Array<{ role: string; content: unknown }>
): {
  isMultiDoc: boolean;
 ...
 */
export function generateMultiDocInstructions(
  uploadedDocs: Array<{ content: string; type: 'spreadsheet' | 'pdf' | 'text' }>,
  extractionHints: string[],
  userMessage: string
): string {
...
export function hasEnoughDetailToGenerate(
  message: string,
 ...
 */
export function generateDocumentResponseMessage(
  documentType: string,
  filename: string,
  subtype: string
): string {
...
export function getDocumentSchemaPrompt(documentType: string, userMessage?: string): string {
