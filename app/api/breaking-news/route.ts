 ...
 *
 * BATCHED GENERATION:
 * - 11 category groups, each generated with focused API call
...
async function generateBreakingNews(): Promise<string> {
  ...
  console.log(`[Breaking News] Starting batched generation at ${formattedDateTime}`);
  console.log(`[Breaking News] Generating ${CATEGORY_GROUPS.length} category groups...`);
