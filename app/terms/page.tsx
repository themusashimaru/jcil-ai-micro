    ...
    <div className="min-h-screen bg-black">
      ...
      <main className="container mx-auto px-4 py-12 max-w-4xl">
        ...
        <div className="space-y-8 text-gray-300">
          ...
          <section>
            <h2 className="text-2xl font-bold text-white mb-4">3. User Conduct & Acceptable Use</h2>
            <p>
              To maintain the integrity and purpose of our community, strict adherence to our Code of Conduct is required.
            </p>

            <h3 className="text-xl font-bold text-white mt-6 mb-3">A. Prohibited Content</h3>
            <p>You agree not to use the Service to generate, promote, or share content that includes:</p>
            <ul className="list-disc ml-6 mt-4 space-y-2">
              <li>
                <strong>Blasphemy & Profanity:</strong> Strict zero-tolerance for vulgar language, profanity, or taking the names of God, Jesus Christ, or the Holy Spirit in vain.
              </li>
              <li>
                <strong>Obscenity:</strong> Pornographic, sexually explicit, or violent content.
              </li>
              <li>
                <strong>Illegal Acts:</strong> Content that promotes illegal activities or harm to self or others.
              </li>
            </ul>
            ...
            <ul className="list-disc ml-6 mt-4 space-y-2">
              <li>
                <strong>Prompt Injection:</strong> Using complex logic or roleplay to force the AI to ignore its system instructions.
              </li>
              <li>
                <strong>Filter Evasion:</strong> Attempting to generate content that violates our values by disguising the intent.
              </li>
              <li>
                <strong>Reverse Engineering:</strong> Attempting to discover the source code, system prompts, or underlying architecture of JCIL.AI.
              </li>
            </ul>
          </section>

          <section>
            <h2 className="text-2xl font-bold text-white mb-4">4. Enforcement & Termination</h2>
            <p>JCIL.AI reserves the right to monitor user inputs using automated moderation systems.</p>
            <ul className="list-disc ml-6 mt-4 space-y-2">
              <li>
                <strong>Violation Consequences:</strong> If you violate the prohibitions in Section 3, we reserve the right to immediately suspend or permanently terminate your access to the Service without prior notice.
              </li>
              <li>
                <strong>Refunds:</strong> Users terminated for violating these Terms are not eligible for refunds on any paid subscriptions.
              </li>
            </ul>
          </section>

          <section>
            <h2 className="text-2xl font-bold text-white mb-4">5. Disclaimer of Warranties (AI Limitations)</h2>
          ...
          <section>
            ...
            <ul className="list-disc ml-6 space-y-2">
              <li>
                <strong>Your Content:</strong> You retain ownership of the inputs you provide.
              </li>
              <li>
                <strong>Our Content:</strong> The interface, branding, logos, and custom code of JCIL.AI are the property of JCIL.AI.
              </li>
              <li>
                <strong>AI License:</strong> You are granted a limited, non-exclusive right to use the AI-generated outputs for your personal or internal business use, subject to the restrictions of our upstream providers (xAI).
              </li>
            </ul>
          </section>

          <section>
            <h2 className="text-2xl font-bold text-white mb-4">7. Data Handling & Privacy</h2>
